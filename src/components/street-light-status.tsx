			...
			<div className="smart-city-content">
				{loading ? (
					...
					<div className="status-content">
						<div className="status Attention">
							<h3>
								{(health?.ilmAlerts?.["Main Fail"] ?? 0) +
									(health?.ilmAlerts?.["Lamp Flickering"] ?? 0)}
								<span></span>
							</h3>
							<p>High</p>
						</div>
						...
						<div className="status Pending">
							<h3>
								{(health?.ilmAlerts?.["Load Fail"] ?? 0) +
									(health?.ilmAlerts?.["Lux Sensor Blocked"] ?? 0) +
									(health?.ilmAlerts?.["Partial Failure"] ?? 0)}{" "}
								<span></span>
							</h3>
							<p>Medium</p>
						</div>
						...
						<div className="status Resloved">
							<h3>
								{(health?.ilmAlerts?.["Power Factor"] ?? 0) +
									(health?.ilmAlerts?.["AC Voltage"] ?? 0)}{" "}
								<span></span>
							</h3>
							<p>Low</p>
						</div>
					...
					<WidgetWrapper className="smart-city_box energy_consumption-box  expenditure-box">
						...
						<div className="smart-city-content">
							<div className="technician_chart">
								...
								<div
									className="status-expenditure-chart"
